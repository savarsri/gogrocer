...
class PaymentGatewayScreen extends BaseRoute {
  ...
  PaymentGatewayScreen({super.analytics, super.observer, super.routeName = 'PaymentGatewayScreen', this.screenId, this.totalAmount, this.membershipModel, this.order, this.cartController});
  @override
