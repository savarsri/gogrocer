...
class IntroScreen extends BaseRoute {
  IntroScreen({super.analytics, super.observer, super.routeName = 'IntroScreen'});
...
class _IntroScreenState extends BaseRouteState {
  ...
  Widget circleBar(bool isActive) {
    return AnimatedContainer(
      ...
      decoration: BoxDecoration(color: isActive ? Theme.of(context).colorScheme.primary : Theme.of(context).colorScheme.primary.withOpacity(0.5), borderRadius: BorderRadius.all(Radius.circular(12))),
    );
  }
