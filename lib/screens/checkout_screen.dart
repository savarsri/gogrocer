...
class CheckoutScreen extends BaseRoute {
  ...
  CheckoutScreen({super.analytics, super.observer, super.routeName = 'CheckoutScreen', this.cartController});
                ...
                children: [
                  Text(
                    global.userProfileController.addressList.length > 0
                        ? "${AppLocalizations.of(context)!.lbl_shipping_to} Shipping to "
                  ...
                  Container(
                    ...
                    child: global.userProfileController.addressList.isNotEmpty
                        ? ListView.builder(
                            shrinkWrap: true,
