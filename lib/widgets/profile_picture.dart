  ...
  Future<File?> openCamera() async {
    try {
      ...
      if (_selectedImage != null) {
        ...
        if (_finalImage != null) {
          final _compressedImage = await _imageCompress(_finalImage, imageFile.path);
          if (_compressedImage != null) {
            _finalImage = File(_compressedImage.path);
  ...
  Future<File?> selectImageFromGallery() async {
    try {
      ...
      if(_selectedImage != null) {
        ...
        if(_byteData != null) {
          final _compressedImage = await _imageCompress(_byteData, imageFile.path);
          if(_compressedImage != null) {
            _byteData = File(_compressedImage.path);
            return _byteData;
          }
        }
      }
