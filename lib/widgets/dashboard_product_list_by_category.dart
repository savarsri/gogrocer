...
class DashboardProductListByCategory extends StatelessWidget {
  ...
  DashboardProductListByCategory({super.key, this.analytics, this.observer, required this.productListByCategory});
                        ...
                        InkWell(
                          onTap: () {
                            Get.to(() => ProductListScreen(
                              ...
                              observer: observer,
                              screenId: 0,
                              categoryName: productListByCategory[index].cat_title,
                              categoryId: productListByCategory[index].cat_id,
                            ));
                          },
                          child: Text(
